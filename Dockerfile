...
ARG NEXT_PUBLIC_ENABLE_REPORTING="false"
ARG NEXT_PUBLIC_MAP_COUNTRY_CODES=""
ARG SENTRY_AUTH_TOKEN=""

# Elevate these vars to ENV so `next build` can use them
...
ENV NEXT_PUBLIC_ENABLE_COUNTRY_REGION=$NEXT_PUBLIC_ENABLE_COUNTRY_REGION
ENV NEXT_PUBLIC_MAP_COUNTRY_CODES=$NEXT_PUBLIC_MAP_COUNTRY_CODES
ENV NEXT_PUBLIC_ENABLE_REPORTING=$NEXT_PUBLIC_ENABLE_REPORTING
