...
const cacheTags: CacheTag[] = [
  ...
  { tag: 'form-templates:list', description: 'Form templates', category: 'Templates' },
  { tag: 'lda-forms:list', description: 'Form responses, incl. the template each form renders', category: 'Templates' },
